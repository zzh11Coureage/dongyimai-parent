				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<#if imageList??>
							<span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400px" height="800px" /></span>
						</div>
						</#if>
						<!--下方的缩略图-->
...
购热销商品</em>
					...
					<div class="support">
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								<em class="t-gray">{{specificationItems}}</em>
							</div>
						</div>
					</div>

<#--					读取商品规格和规格选项-->
					<#assign specifictionList=goodsDesc.specificationItems?eval/>
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							<#if specifictionList??>
								<#list specifictionList as spec>
							<dl>
								<dt>
									<div class="fl title">
							...
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#if customAttributeList??>
										<#list customAttributeList as ca>

											<li>${ca.text}:${ca.value}</li>-->
										</#list>
